...
public class SuiJiDataBeanParceable implements Parcelable
{
    private SuiJiDataBean suiJiDataBean;

    public SuiJiDataBeanParceable(SuiJiDataBean suiJiDataBean)
    {
        this.suiJiDataBean = suiJiDataBean;
    }

    protected SuiJiDataBeanParceable(Parcel in)
    {
        location = in.readString();
        main_message = in.readString();
        the_date = in.readString();
        username = in.readString();
        labels = in.readString();
        fileType = in.readInt();
        have_file = in.readInt();
        bitmapMap = in.readHashMap(HashMap.class.getClassLoader());
        suiji_id = in.readInt();
        goods = in.readInt();
        comment_number = in.readInt();
        looks_number = in.readInt();
    ...
    {
        dest.writeString(suiJiDataBean.getLocation());
        dest.writeString(suiJiDataBean.getMain_message());
        dest.writeString(suiJiDataBean.getThe_date());
        dest.writeString(suiJiDataBean.getUsername());
        dest.writeString(suiJiDataBean.getLabels().toString());
        dest.writeInt(suiJiDataBean.getFileType());
        dest.writeInt(suiJiDataBean.getHave_file());
        dest.writeMap(suiJiDataBean.getBitmapMap());
        dest.writeInt(suiJiDataBean.getSuiji_id());
        dest.writeInt(suiJiDataBean.getGoods());
        dest.writeInt(suiJiDataBean.getComment_number());
        dest.writeInt(suiJiDataBean.getLooks_number());
        dest.writeString(suiJiDataBean.getUserHead());
        dest.writeString(suiJiDataBean.getNickName());
    }

    public static final Creator<SuiJiDataBeanParceable> CREATOR = new Creator<SuiJiDataBeanParceable>() {
        @Override
        public SuiJiDataBeanParceable createFromParcel(Parcel in) {
            return new SuiJiDataBeanParceable(in);
        }

        @Override
        public SuiJiDataBeanParceable[] newArray(int size) {
            return new SuiJiDataBeanParceable[size];
        }
    };
